...
import com.example.nour.myfood.ViewHolder.MenuViewHolder;
...
FirebaseRecyclerAdapter<Category,MenuViewHolder> adapter ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textName=hederView.findViewById(R.id.textName);
        textName.setText(Common.currentUser.getName());
        recycler_menu=findViewById(R.id.recycle_view);
        ...
        adapter = new FirebaseRecyclerAdapter<Category,
            ...
            protected void populateViewHolder(MenuViewHolder viewHolder, Category model, int position) {
             viewHolder.textMenuName.setText(model.getName());
                ...
                final Category clickItme =model;
